...
const sourceNodes = async ({
  ...
  try {
    ...
    await createNodes(`blogs`, _queries.BLOGS_QUERY, _nodes.BlogNode, args)

    await createNodes(`articles`, _queries.ARTICLES_QUERY, _nodes.ArticleNode, args, async x => {
    ...
    await createNodes(`products`, _queries.PRODUCTS_QUERY, _nodes.ProductNode, args, async x => {
    ...
    await createNodes(`productTypes`, _queries.PRODUCT_TYPES_QUERY, _nodes.ProductTypeNode, args)
